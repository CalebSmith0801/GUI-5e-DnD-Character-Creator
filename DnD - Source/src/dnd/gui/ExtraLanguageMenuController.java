...
import dnd.gui.Races.WizardCantripMenuController;
import dnd.gui.Races.AbilityRaceBonusMenuController;
import dnd.gui.Races.HalfElfVariantController;
...
public class ExtraLanguageMenuController implements Initializable {
   ...
   public void setCharacter(Character c){
        ...
        for(int i = 0; i < rbList.size(); i++){
            if(c.getLanguages().contains(rbList.get(i).getText()))
