   ...
   @FXML
    private void backButton(ActionEvent event){
        ...
        try{
            ...
            root = loader.load();
            switch(prevWindow){                
                case "RaceMenus/WizardCantripMenu.fxml":                    
                ...
                case "raceSelectionMenu.fxml":
                    ...
                    break;
                case "RaceMenus/AbilityRaceBonusMenu.fxml":
                    ...
                    if(character.getCharRaceBonus() == 1)
                        raceBonusCtrl.setCheckBoxOnSceneReload("Charisma");
    ...
    private void nextButton(ActionEvent event){
        ...
        prevWindows.add("RaceMenus/ExtraLanguageMenu.fxml");
        Parent root;
        try{
