...
public class AbilityRaceBonusMenuController implements Initializable {
    ...
    private void nextButton(){
        Parent root;
        prevWindows.add("RaceMenus/AbilityRaceBonusMenu.fxml");
        ...
        try{
            if (character.getsubraceName().equals("Half-Elf Variant")){
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/dnd/CharCreation/RaceMenus/HalfElfVariant.fxml"));
                root = loader.load();
    ...
    public void setCheckBoxOnSceneReload(String bonus){
        switch(bonus){
            case "Strength":
                strCB.setSelected(true);
                break;
            case "Dexterity":
                dexCB.setSelected(true);
                break;
            case "Constitution":
                conCB.setSelected(true);
                break;
            case "Intelligence":
                intCB.setSelected(true);
                break;
            case "Wisdom":
                wisCB.setSelected(true);
                break;
            case "Charisma":
